...
MAP_BUILDER.pose_graph.optimization_problem.huber_scale = 15e2
--MAP_BUILDER.pose_graph.optimize_every_n_scans = 320
...
MAP_BUILDER.pose_graph.constraint_builder.min_score = 0.20
